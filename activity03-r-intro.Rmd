...
**Response**:
putting , between I and J works.
adding Backslash before " works.
...
**Response**:
dataframe has syntax of data.frame
"symbol" is sorrounded by quotation mark
...
**Response**:
"nrow" is the function to find number of rows. dataframe symbols are in rows.
